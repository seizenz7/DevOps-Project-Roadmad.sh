...
Write a script server-stats.sh that can analyse basic server performance stats. The script should be able to run on any Linux server and it should give the following stats:
